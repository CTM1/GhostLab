...
/**
 * LabyrInterface.java Interface that describes the things a Labyrinth must do.
 *
 * @since 04.04.2022
 * @author ekip
 */
public interface LabyrInterface {
  ...
  /**
   * This method takes the coordinates of a player, a direction, a distance, and returns either the
   * max distance the player could cover before meeting a wall, or the distance they wanted to
   * cover.
   *
  ...
  /**
   * This methods finds a random empty case
   *
   * @return [x, y]
   */
